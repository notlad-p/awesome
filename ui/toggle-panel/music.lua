...
local backward_fg = gears.color.recolor_image(beautiful.backward, beautiful.fg)
local play_fg = gears.color.recolor_image(beautiful.play, beautiful.fg)
local pause_fg = gears.color.recolor_image(beautiful.pause, beautiful.fg)
local forward_fg = gears.color.recolor_image(beautiful.forward, beautiful.fg)
...
playerctl:connect_signal("playback_status", function(_, playing)
  if playing then
    play_icon:set_image(pause_fg)
  else
    play_icon:set_image(play_fg)
  end
end)
